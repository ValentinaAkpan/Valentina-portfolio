        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg text-gray-300 leading-relaxed">
              ...
              <span className="text-purple-400 font-semibold"> data analysis</span>, and 
              <span className="text-pink-400 font-semibold"> network operations</span>.
            </p>
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              ...
              the gap between technical complexity and practical solutions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700 hover:border-green-400 transition-colors duration-300">
              <h3 className="text-green-400 font-semibold text-xl mb-2">Problem Solving</h3>
              <p className="text-gray-400">Critical thinking and innovative solution development</p>
            </div>
          </div>
        </div>
      </div>
