const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      type: "Freelance",
      responsibilities: [
        "Managed comprehensive data systems and databases to support business operations and decision-making across multiple client companies",
        "Provided administrative support and automation expertise to various organizations including:",
